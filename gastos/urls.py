...
urlpatterns = [
    ...
    path('onboarding/business/', views.onboarding_business, name='onboarding_business'),
    ...
    path('onboarding/result/', views.onboarding_result, name='onboarding_result'),
    path('profile/restart/', views.restart_profile_assessment, name='restart_profile_assessment'),
    path('imports/', views.imports, name='imports'),
    path('imports/<uuid:public_id>/review/', views.import_review, name='import_review'),
    path('imports/<uuid:public_id>/confirm/', views.import_confirm, name='import_confirm'),
    path('imports/<uuid:public_id>/cancel/', views.import_cancel, name='import_cancel'),
